...
var _weapons := []
var _weapon_index := -1 setget _set_weapon_index

onready var _weapon_anchor: Position2D = $WeaponAnchor

onready var _weapon: Weapon = null
onready var _hand_left: Sprite = $WeaponAnchor/HandLeft
onready var _hand_right: Sprite = $WeaponAnchor/HandRight
...
func set_weapon(new_weapon: Weapon) -> void:
	...
	var hand_texture: Texture = WEAPONS_HANDS_MAP[_weapon.name]
...
func _set_weapon_index(new_weapon_index: int) -> void:
	...
	set_weapon(_weapons[_weapon_index].instance())
