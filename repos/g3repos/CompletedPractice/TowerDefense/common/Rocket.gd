...
func _physics_process(delta: float) -> void:
	# We call this function in _physics_process() to move the rocket every
	# frame.
	_move(delta)


# We can replace the move function when creating new kinds of rockets. We'll do
# that later in the series to create a homing rocket.
